/****************************************************************************
** Meta object code from reading C++ file 'win_start.h'
**
...
#include "../robot_ui/win_start.h"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'win_start.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_StartWindow[] = {
    "StartWindow\0\0login_success()\0openwindow()\0"
    "login()\0emit_success()\0logout()\0"
};
...
const QMetaObject StartWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_StartWindow,
...
// SIGNAL 0
void StartWindow::login_success()
{
